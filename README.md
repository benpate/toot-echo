...
[![Go Reference](https://pkg.go.dev/badge/github.com/benpate/toot-echo.svg)](https://pkg.go.dev/github.com/benpate/toot-echo)
...
Toot-echo connects the [toot](https://github.com/benpate/toot) library to the [echo](https://echo.labstack.com/) router. This makes it easy for you to Mastodon-ize your Go/echo application.
